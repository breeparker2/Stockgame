// package hub;  // <-- uncomment & set if this file is inside a package folder
...
public class hub extends Application {
    ...
    // brightness effect for the whole hub
    ...
    // Track if we're on hub; timed visits are hub-only
    ...
    public void start(Stage primaryStage) {
        ...
        // ---- Bridge timer: detect new/ended engine events → publish into your EventBus
        ...
        // --- Digital clock (top-right on hub) ---
        initClock(root);
        refreshStatus();
        startWorkdayTimer();
    ...
    // at start-of-day pick the pool for *today* and (re)load the engine
